import {Stage0, Stage1, Stage2, Stage3, CompletionStage} from "./stages.mjs";
...
export class Yantra {
  constructor(circleRadius, two) {
    ...
    this.completionStage = new CompletionStage(two, revealTime, this);
  ...
  draw(two, frameCount) {
    ...
    this.completionStage.update(frameCount);
  }
